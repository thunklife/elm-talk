...
Elm.Main.make = function (_elm) {
   ...
   var totalOps = function (value) {
      return function () {
         var opsText = A2($Basics._op["++"],
         "Number of operations: ",
         $Basics.toString(value));
         return A2($Html.span,
         _L.fromArray([]),
         _L.fromArray([$Html.text(opsText)]));
      }();
   };
   var currentValue = function (value) {
      return function () {
         var valueText = A2($Basics._op["++"],
         "The current value is: ",
         $Basics.toString(value));
         return A2($Html.span,
         _L.fromArray([]),
         _L.fromArray([$Html.text(valueText)]));
      }();
   };
   var pageHeader = A2($Html.h2,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Elm HTML Example")]));
   var stopAtZero = function (n) {
      return function () {
         switch (n)
         {case 0: return 0;}
         return n - 1;
   ...
   var ResetValue = {ctor: "ResetValue"};
   var resetButtons = function (address) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.button,
                   ...
                   address,
                   ResetAll)]),
                   _L.fromArray([$Html.text("Reset All")]))]));
   };
   var Decrement = {ctor: "Decrement"};
   var Increment = {ctor: "Increment"};
   var counterButtons = function (address) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.button,
                   _L.fromArray([A2($Html$Events.onClick,
      ...
      return function () {
         ...
         {case "Decrement":
            return _U.replace([["value"
                               ,stopAtZero(model.value)]
                              ,["opCount",model.opCount + 1]],
              model);
            case "Increment":
            return _U.replace([["value"
                               ,model.value + 1]
